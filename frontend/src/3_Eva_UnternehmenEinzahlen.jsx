...
import './3_Eva_UnternehmenEinzahlen.css'  //Wichtig immer CSS importieren

export default function Eva_UnternehmenEinzahlen() {
    ...
    <div className="ue-seite">
      ...
      <div className="ue-inhalt">
        ...
        <div className="ue-feld">
          ...
          <span className="feld-input anzeige ue-kontostand-neu">{kontostandNeu !== '' ? `${kontostandNeu} Stuggis` : ''}</span>
          {/* === ENDE BACKEND === */}
        </div>
      </div>
    </div>
